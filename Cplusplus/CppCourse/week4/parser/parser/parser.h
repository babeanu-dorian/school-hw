...
class Parser: public ParserBase
{
    ...
    static constexpr double E_VAL = 2.718281828459;
    static constexpr double PI_VAL = 3.14159265359;
    ...
    ANGLE_TYPE d_angleType = ANGLE_RAD;
    ...
    // added functions for the calculator:
        ...
        RuleValue angleOut(double rad);
        RuleValue value();
        RuleValue variable();

        double valueOf(RuleValue const &e);
        double angleIn(RuleValue const &e);
};
